...
class Item(BaseModel):
    ...
    def fill(self, ctx: Context) -> Self:
        ...
        version = opts.minecraft_version if opts.minecraft_version != "latest" else LATEST_MINECRAFT_VERSION
        ...
        if self.id.removeprefix("minecraft:") in components:
            self.components = {**components[self.id.removeprefix("minecraft:")], **self.components}
        return self
